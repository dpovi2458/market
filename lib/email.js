...
export async function sendOTPEmail(emailInstitucional, codigoOTP, isPasswordReset = false) {
  try {
    ...
    const mailOptions = {
      ...
      subject: isPasswordReset ? '🔐 Recuperación de Contraseña - Market Facultad' : '✅ Código de Verificación - Market Facultad UNMSM',
...
function generarHTMLRecuperacion(codigoOTP) {
  return `
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Recuperación de Contraseña - Market Facultad</title>
        <style>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Recibimos una solicitud para restablecer la contraseña de tu cuenta en Market Facultad.</p>
